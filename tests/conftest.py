...
mock_picographics.PicoGraphics.return_value.clear = mock.Mock()
...
mock_picovector.PicoVector.return_value.draw = mock.Mock()
mock_picovector.PicoVector.return_value.set_font_size = mock.Mock()
mock_picovector.PicoVector.return_value.text = mock.Mock()
mock_picovector.PicoVector.return_value.measure_text = mock.Mock()
mock_picovector.PicoVector.return_value.measure_text.return_value = (0, 0, 50, 20)
mock_picovector.Transform = mock.create_autospec(object, instance=False)
mock_picovector.Polygon = mock.create_autospec(object, instance=False)
mock_picovector.Polygon.return_value.path = mock.Mock()
mock_picovector.Polygon.return_value.circle = mock.Mock()
